...
public class DataManager {
	...
	public void reloadConfig() {
		...
		InputStream defaultStream = MSG.getInstance().getResource(fileName);
	...
	public void saveConfig() {
		...
		try {
			...
			MSG.getInstance().getLogger().log(Level.SEVERE, "Could not save config to " + configFile, e);
		} 
	}
	...
	public void saveDefaultConfig() {
		...
		if (!configFile.exists())
			MSG.getInstance().saveResource(path + "/" + fileName, false);
	}
}
